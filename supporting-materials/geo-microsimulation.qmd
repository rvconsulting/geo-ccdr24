...
ca_microsim_cc01 <- ca_microsim01 |> 
...
for (yr in analysis_years) {
  for (sc in scenarios) {
    ...
    inc <- ca_microsim02[[inc_var]]
    wgt <- ca_microsim02[[wgt_var]]
...
for (yr in analysis_years) {
  for (sc in sc_subset) {
    ...
    ca_microsim04[[poor_pc_col]] <- if_else(
      ca_microsim04[[ae_pc_col]] < pline, 1L, 0L
    )
  }
}
...
poor_2030_baseline_cc <- ca_microsim_cc02 |>
...
poor_2050_baseline_cc <- ca_microsim_cc02 |>
...
# Dry/Hot
poor_2030_dryhot_pc <- ca_microsim04 |>
...
poor_2050_dryhot_pc <- ca_microsim04 |>
...
# Wet/Warm
poor_2030_wetwarm_pc <- ca_microsim04 |>
...
poor_2050_wetwarm_pc <- ca_microsim04 |>
...
# NZS
poor_2030_nzs_pc <- ca_microsim04 |>
...
poor_2050_nzs_pc <- ca_microsim04 |>
...
```{r}
poor_2030_cc_region <- ca_microsim_cc02 |> 
...
poor_2023_region <- ca_microsim01  |> 
