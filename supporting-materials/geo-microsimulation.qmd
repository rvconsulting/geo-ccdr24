...
income_vars <- names(ca_microsim06)[grepl("^aecons_\\d{4}(_[a-zA-Z0-9]+)?$", names(ca_microsim06))]
...
calculate_measures <- function(income_var, weight_var) {
  income <- ca_microsim06[[income_var]]
  weight <- ca_microsim06[[weight_var]] * ca_microsim06$hhsize
